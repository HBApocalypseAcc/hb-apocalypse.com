...
#define DEF_MAXHPRELIQUIA			500000 //500000
#define DEF_MAXHPRELIQUIAWWII		350000
#define DEF_MAXHPRELIQUIAHOD		50000 //500000
...
public:
	...
	int	 m_iExpDiceMax;
	int  m_iGoldDiceMin;
	int  m_iGoldDiceMax;				// 죽었을 경우 얻게되는 경험치 주사위 굴림 X dice 4
