...
#define DEF_QUESTTYPE_MONSTERHUNT_CONTRIB		1		// 일반적인 몬스터 헌팅 
#define DEF_QUESTTYPE_MONSTERHUNT_RARE			2		// 시간 제한이 걸려있는 몬스터 헌팅 
#define DEF_QUESTTYPE_MONSTERHUNT_STATED		3		// 암살 
...
public:
	...
	unsigned int m_iMaxCount;			// 최대 만족 횟수 
