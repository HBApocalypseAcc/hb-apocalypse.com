//#define MSGID_RESPONSE_INITPLAYER_OLD		0x0F01
...
#define MSGID_REQUEST_INITPLAYER			0x45756765
#define MSGID_PREVENTCLIENTHACK				0x09464562
#define MSGID_REQUEST_INITDATA				0x65098345
#define MSGID_RESPONSE_INITDATA				0x56795683

// ZeroEoyPnk
#define MSGID_COMMAND_MOTION				0x45697483
#define MSGID_RESPONSE_MOTION				0x45689434
#define MSGID_EVENT_MOTION					0x49603823
#define MSGID_EVENT_LOG						0x17826823
#define MSGID_EVENT_COMMON					0x09568222
#define MSGID_COMMAND_COMMON				0x87236424 
#define MSGID_COMMAND_CHECKCONNECTION		0x40958493
#define MSGID_COMMAND_CHATMSG				0x98347398
...
#define	DEF_COMMONTYPE_REQ_BANME						0x0A63
 ...
 #define CLIENT_NOTIFY_HP								0x0B07
...
#define MSGID_REQUEST_FORCEDISCONECTACCOUNT		0x3465223C
...
//#define MSGID_RESPONSE_MAPERVER					0x280120A0
...
//nuevo Happy Day LaloRamos 4.0
#define DEF_NOTIFY_HAPPYDAYSTAR					0x0F12
#define DEF_NOTIFY_HAPPYDAYEND				     	0x0F13
...
//Fury Day
#define DEF_NOTIFY_FURYDAY							0x0B911
#define DEF_NOTIFY_ENDFURYDAY						0x0B912

//Top Ek - NetPanel
#define RESPONSE_TOPMEMORY_EK					0x01AB3
#define REQUEST_TOPMEMORY						0x01AB4

#define DEF_COMMONTYPE_REQ_GETTRADEEKITEMS	0x0200

#define DEF_SEND_EVENTDATA						0x1F01

#define DEF_COMMONTYPE_REPAIR_ALL				0x0A62

//Capture The Flag
#define DEF_NOTIFY_CAPTURETHEFLAG					0x0F90
#define DEF_NOTIFY_FLAGCOUNTER						0x0F91

//RushNet
#define DEF_NOTIFY_RUSH							0x1F15
#define DEF_SEND_HPRELIQUIA						0x1F16
#define DEF_NOTIFY_STRUCTURES					0x1F17

#define DEF_NOTIFY_TOWERDEFENCE					0x1F20
#define DEF_NOTIFY_TD_STRUCTURES				0x1F21

#define DEF_NOTIFY_INITALLVSALL					0x1F22
#define DEF_NOTIFY_ENDALLVSALL					0x1F23
#define DEF_NOTIFY_OPENPORTALS					0x1F25

#define DEF_STATUS_REFLEX						0x3F00

#define RESPONSE_TOPMEMORY_CF					0x01AB5
#define RESPONSE_TOPMEMORY_EKD					0x01AB7

#define	DEF_NOTIFY_ABADDONMAP					0x1F02
#define	DEF_NOTIFY_ABADDONMAPCLOSE				0x1F03

#define DEF_COMMONTYPE_RECALL_COORDS			0x3F04

#define DEF_COMMONTYPE_BANKPAGE				0x3F05

#define DEF_NO_DISCONNECT					0x3F06

#define DEF_NOTIFY_CVCOPEN					0x3F07
#define DEF_NOTIFY_CVCEND					0x3F08
#define DEF_NOTIFY_PRICECLOSE				0x3F09
#define DEF_NOTIFY_CVCNOW					0x3F11

#define DEF_NOTIFY_LUPOOL					0x3F12

//World War - LaloRamos
#define DEF_NOTIFY_WWOPEN					0x3F24
#define DEF_NOTIFY_WWEND					0x3F25
#define DEF_NOTIFY_WWNOW					0x3F26

#define	DEF_NOTIFY_STATUSCHAR				0x01AF9
#define DEF_NOTIFY_CHARSTATUS				0x02AF9
#define REQUEST_FULLDATACHAR				0x3F10

//Enemy Kills -> Data Reduction
#define DEF_NOTIFY_ENEMYKILLS1				0x0F100
#define DEF_NOTIFY_ENEMYKILLS2				0x0F101
#define DEF_NOTIFY_ENEMYKILLS3				0x0F102
//Criticals -> Data Reduction
#define DEF_NOTIFY_SUPERATTACKLEFT1			0x0F103
#define DEF_NOTIFY_SUPERATTACKLEFT2			0x0F104
#define DEF_NOTIFY_SUPERATTACKLEFT3			0x0F105
//Contribs -> Data Reduction
#define DEF_NOTIFY_CONTRIBUTION1			0x0F106
#define DEF_NOTIFY_CONTRIBUTION2			0x0F107
#define DEF_NOTIFY_CONTRIBUTION3			0x0F108

//Summon-Event
#define DEF_NOTIFY_SUMMONEVENT				0x0F109
#define	DEF_NOTIFY_NEXTROUND				0x0F110

//Assasain
#define DEF_COMMONTYPE_GETASSASAINHERO		0x0F200
#define	DEF_COMMONTYPE_RESETASSASAIN		0x0F201
#define DEF_COMMONTYPE_CHANGEPKEK			0x0F202
#define	RESPONSE_TOPMEMORY_ASSASAIN			0x0F203
#define	DEF_NOTIFY_CHANGEASSASAIN			0x0F205

#define DEF_NOTIFY_HELLOFDEATH				0x0F210
#define DEF_NOTIFY_HPSTRUCTURE				0x0F211

//New Party System - ZeroEoyPnk
#define DEF_SEND_PARTYCOORDS				0x1F07
#define DEF_SEND_PARTYHP					0x1F08
#define DEF_SEND_PARTYNAME					0x1F09
//#define DEF_RESQUEST_PARTYHP				0x1F09

#define DEF_COMMONTYPE_REQ_TRADEITEM		0x0F30

#define DEF_REQUEST_REMOVEITEMEXCHANGE		0x0F31
#define DEF_RESPONSE_REMOVEITEMEXCHANGE		0x0F32
#define DEF_NOTIFY_WEIGHTEXCHANGE			0x0F33
#define DEF_NOTIFY_EXCHANGEITEMCONFIRM		0x0F34

#define	DEF_NOTIFY_ACHIVEMENTS				0x0F40
#define	DEF_COMMONTYPE_LISTCOMPLETE			0x0F41

#define	DEF_REQUEST_STATUSFRIEND			0x0F50
#define DEF_NOTIFY_STATUSFRIEND				0x0F51
#define	DEF_REQUEST_GUILDMEMBER				0x0F52
#define DEF_NOTIFY_GUILDMEMBER				0x0F53
#define DEF_NOTIFY_STATUSFRIEND2			0x0F54

#define DEF_NOTIFY_F5DATA					0x0F55
#define	DEF_NOTIFY_NOTICEEKMSG				0x0F56

#define	RESPONSE_TOPMEMORY_PLAYERKILL		0x0F60
#define	RESPONSE_TOPMEMORY_DEATHS			0x0F61
#define DEF_NOTIFY_COINS					0x0F62

#define DEF_NOTIFY_NOTENOUGHGOLD2			0x0F63
#define	DEF_NOTIFY_HACKDETECTED				0x0F64
#define RESPONSE_DELETEHACK					0x0F65

#define DEF_NOTIFY_CHECKPROCESS				0x0F66
#define	DEF_NOTIFY_PROCESSANDDLL			0x0F67

#define DEF_NOTIFY_PROCESSBLOCKED			0x0F68

#define DEF_NOTIFY_ARENAPVPEVENT_INIT		0x0F70
#define DEF_NOTIFY_ARENAPVPEVENT_CLOSE		0x0F71
#define RESPONSE_TOPARENAEVENT				0x0F72
#define	RESPONSE_MYDATAEVENT				0x0F73

//#define MSGID_REQUEST_LOGOUT				0x0F80
//#define	MSGID_REQUEST_CANCELLOGOUT			0x0F81

#define COMMONTYPE_REQ_PING					0x0F82
#define	NOTIFY_PINGPLAYERS					0x0F83

#define DEF_ITEMTOSELLLIST					0x0F85
#define	DEF_REQUEST_ITEMLIST				0x0F86
#define DEF_NOTIFY_ITEMLIST					0x0F87
#define DEF_TIPESELLLIST					0x0F88
#define DEF_REPONSE_SELLTYPE				0x0F89

#define DEF_REQUEST_PURCHASE				0x0F92
#define SEND_DELETE_SELL_LIST				0x0F93
#define DEF_NOTIFY_MARKET					0x0F94

#define DEF_REQUEST_BUY_ASSAPOINTS			0x0F230 
#define DEF_NOTIFY_ASSASAINSPOINTS			0x0F231