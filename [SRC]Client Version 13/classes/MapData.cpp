...
CMapData::CMapData(class CGame * pGame)
{
	...
	m_stFrame[i][DEF_OBJECTMOVE].m_sMaxFrame = 7;
	m_stFrame[i][DEF_OBJECTMOVE].m_sFrameTime = 60;
	...
	m_stFrame[i][DEF_OBJECTRUN].m_sFrameTime = 38;
	...
	m_stFrame[i][DEF_OBJECTMAGIC].m_sFrameTime = 80;
	m_stFrame[i][DEF_OBJECTGETITEM].m_sMaxFrame = 3;
	m_stFrame[i][DEF_OBJECTGETITEM].m_sFrameTime = 125;
	...
	for (i = 1; i <= 6; i++)
	{
		...
		m_stFrame[i][DEF_OBJECTMOVE].m_sMaxFrame = 7;
		m_stFrame[i][DEF_OBJECTMOVE].m_sFrameTime = 32 / 1.1;
		m_stFrame[i][DEF_OBJECTDAMAGEMOVE].m_sMaxFrame = 3;
		...
		m_stFrame[i][DEF_OBJECTMAGIC].m_sMaxFrame = 15;
		m_stFrame[i][DEF_OBJECTMAGIC].m_sFrameTime = 40;//40//50 va
		m_stFrame[i][DEF_OBJECTGETITEM].m_sMaxFrame = 3;
		m_stFrame[i][DEF_OBJECTGETITEM].m_sFrameTime = 50 / 1.2;
		m_stFrame[i][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	...
	m_stFrame[10][DEF_OBJECTMOVE].m_sFrameTime = 130;//240;120
	...
	m_stFrame[11][DEF_OBJECTMOVE].m_sFrameTime = 100;//90
	...
	m_stFrame[12][DEF_OBJECTMOVE].m_sFrameTime = 110;//210;//100
	...
	m_stFrame[13][DEF_OBJECTMOVE].m_sFrameTime = 100;//210;80
	...
	m_stFrame[14][DEF_OBJECTMOVE].m_sFrameTime = 90;//150;80
	...
	m_stFrame[15][DEF_OBJECTMOVE].m_sFrameTime = 150;//150;100
	...
	m_stFrame[16][DEF_OBJECTMOVE].m_sFrameTime = 70;//120;60
	...
	m_stFrame[17][DEF_OBJECTMOVE].m_sFrameTime = 50;//120;45
	...
	m_stFrame[18][DEF_OBJECTMOVE].m_sFrameTime = 140;//270;130
	...
	m_stFrame[19][DEF_OBJECTMOVE].m_sFrameTime = 150;//210;100
	...
	m_stFrame[20][DEF_OBJECTMOVE].m_sFrameTime = 150;//210;100
	...
	m_stFrame[21][DEF_OBJECTMOVE].m_sFrameTime = 90;//150;80
	...
	m_stFrame[22][DEF_OBJECTMOVE].m_sFrameTime = 90;//150;80
	...
	m_stFrame[23][DEF_OBJECTMOVE].m_sFrameTime = 90;//150;80
	...
	m_stFrame[27][DEF_OBJECTMOVE].m_sFrameTime = 50;//50
	...
	m_stFrame[28][DEF_OBJECTMOVE].m_sFrameTime = 130;//100
	...
	m_stFrame[34][DEF_OBJECTMOVE].m_sFrameTime = 150;//120//130
	...
	m_stFrame[34][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;//3 +4
	m_stFrame[34][DEF_OBJECTDYING].m_sFrameTime = 240;
	m_stFrame[34][DEF_OBJECTDYING].m_sMaxFrame = 7;//7
	...
	m_stFrame[61][DEF_OBJECTMOVE].m_sFrameTime = 70;//60;
	...
	m_stFrame[62][DEF_OBJECTMOVE].m_sFrameTime = 70;//60
	...
	// 73 FireWyvern
	m_stFrame[73][DEF_OBJECTSTOP].m_sFrameTime = 150;//250
	...
	//81 Abaddon
	m_stFrame[81][DEF_OBJECTSTOP].m_sFrameTime = 200;//250
	...
	// 90 Gail
	m_stFrame[90][DEF_OBJECTSTOP].m_sFrameTime = 180;
	m_stFrame[90][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[90][DEF_OBJECTMOVE].m_sFrameTime = 100;//150;
	m_stFrame[90][DEF_OBJECTATTACK].m_sFrameTime = 150;
	m_stFrame[90][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[90][DEF_OBJECTDAMAGE].m_sFrameTime = 180;
	m_stFrame[90][DEF_OBJECTDAMAGE].m_sMaxFrame = 3;
	m_stFrame[90][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[90][DEF_OBJECTDYING].m_sMaxFrame = 7;
	...
	m_stFrame[92][DEF_OBJECTSTOP].m_sMaxFrame = 0;
	m_stFrame[92][DEF_OBJECTMOVE].m_sFrameTime = 80;
	m_stFrame[92][DEF_OBJECTMOVE].m_sMaxFrame = 3;
	m_stFrame[92][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[92][DEF_OBJECTATTACK].m_sMaxFrame = 0;
	m_stFrame[92][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[92][DEF_OBJECTDAMAGE].m_sMaxFrame = 0;
	m_stFrame[92][DEF_OBJECTDYING].m_sFrameTime = 200;
	m_stFrame[92][DEF_OBJECTDYING].m_sMaxFrame = 0;

	//New Mobs - ZeroEoyPnk
	// Ice-Worm
	m_stFrame[93][DEF_OBJECTSTOP].m_sFrameTime = 240;
	m_stFrame[93][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[93][DEF_OBJECTMOVE].m_sFrameTime = 120;//240;
	m_stFrame[93][DEF_OBJECTATTACK].m_sFrameTime = 90;
	m_stFrame[93][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[93][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[93][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[93][DEF_OBJECTDYING].m_sFrameTime = 240;
	m_stFrame[93][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Fire-Worm
	m_stFrame[94][DEF_OBJECTSTOP].m_sFrameTime = 300;
	m_stFrame[94][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[94][DEF_OBJECTMOVE].m_sFrameTime = 100;
	...
	m_stFrame[95][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[95][DEF_OBJECTMOVE].m_sFrameTime = 90;
	m_stFrame[95][DEF_OBJECTATTACK].m_sFrameTime = 90;
	m_stFrame[95][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[95][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[95][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[95][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[95][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Red-Demon
	m_stFrame[96][DEF_OBJECTSTOP].m_sFrameTime = 210;
	m_stFrame[96][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[96][DEF_OBJECTMOVE].m_sFrameTime = 100;//270;
	m_stFrame[96][DEF_OBJECTATTACK].m_sFrameTime = 150;
	m_stFrame[96][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[96][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[96][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[96][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[96][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Wood Golem
	m_stFrame[97][DEF_OBJECTSTOP].m_sFrameTime = 200;//120
	m_stFrame[97][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[97][DEF_OBJECTMOVE].m_sFrameTime = 100;//120;60
	m_stFrame[97][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[97][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[97][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[97][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[97][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[97][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Ice Lizzard
	m_stFrame[98][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[98][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[98][DEF_OBJECTMOVE].m_sFrameTime = 80;//150;
	m_stFrame[98][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[98][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[98][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[98][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[98][DEF_OBJECTDYING].m_sFrameTime = 180;
	...
	m_stFrame[99][DEF_OBJECTMOVE].m_sFrameTime = 80;//150;
	m_stFrame[99][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[99][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[99][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[99][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[99][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[99][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Snoob
	m_stFrame[100][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[100][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[100][DEF_OBJECTMOVE].m_sFrameTime = 50;
	m_stFrame[100][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[100][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[100][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[100][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[100][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[100][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Fire Snoob
	m_stFrame[101][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[101][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[101][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[101][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[101][DEF_OBJECTATTACK].m_sMaxFrame = 5;
	m_stFrame[101][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[101][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[101][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[101][DEF_OBJECTDYING].m_sMaxFrame = 9;

	// Satan
	m_stFrame[102][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[102][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[102][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[102][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[102][DEF_OBJECTATTACK].m_sMaxFrame = 5;
	m_stFrame[102][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[102][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[102][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[102][DEF_OBJECTDYING].m_sMaxFrame = 9;

	// Giant Spider
	m_stFrame[103][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[103][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[103][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[103][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[103][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[103][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[103][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[103][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[103][DEF_OBJECTDYING].m_sMaxFrame = 9;

	// Diablo
	m_stFrame[104][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[104][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[104][DEF_OBJECTMOVE].m_sFrameTime = 120;
	m_stFrame[104][DEF_OBJECTATTACK].m_sFrameTime = 100;
	m_stFrame[104][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[104][DEF_OBJECTDAMAGE].m_sFrameTime = 100;
	m_stFrame[104][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	m_stFrame[104][DEF_OBJECTDYING].m_sFrameTime = 150;
	m_stFrame[104][DEF_OBJECTDYING].m_sMaxFrame = 7 + 3;

	// Stalker
	m_stFrame[105][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[105][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[105][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[105][DEF_OBJECTATTACK].m_sFrameTime = 60;
	m_stFrame[105][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[105][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[105][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 7;
	m_stFrame[105][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[105][DEF_OBJECTDYING].m_sMaxFrame = 9;

	// Yeti
	m_stFrame[106][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[106][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[106][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[106][DEF_OBJECTATTACK].m_sFrameTime = 60;
	m_stFrame[106][DEF_OBJECTATTACK].m_sMaxFrame = 12;
	m_stFrame[106][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[106][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	m_stFrame[106][DEF_OBJECTDYING].m_sFrameTime = 70;
	m_stFrame[106][DEF_OBJECTDYING].m_sMaxFrame = 7 + 3;

	// Giant Ettin
	m_stFrame[107][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[107][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[107][DEF_OBJECTMOVE].m_sFrameTime = 90;
	m_stFrame[107][DEF_OBJECTATTACK].m_sFrameTime = 100;
	m_stFrame[107][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[107][DEF_OBJECTDAMAGE].m_sFrameTime = 100;
	m_stFrame[107][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	m_stFrame[107][DEF_OBJECTDYING].m_sFrameTime = 150;
	m_stFrame[107][DEF_OBJECTDYING].m_sMaxFrame = 7 + 3;

	// HellDeath
	m_stFrame[108][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[108][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[108][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[108][DEF_OBJECTATTACK].m_sFrameTime = 60;
	m_stFrame[108][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[108][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[108][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 7;
	m_stFrame[108][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[108][DEF_OBJECTDYING].m_sMaxFrame = 9;

	// Lightworm
	m_stFrame[109][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[109][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[109][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[109][DEF_OBJECTATTACK].m_sFrameTime = 60;
	m_stFrame[109][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[109][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[109][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 7;
	m_stFrame[109][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[109][DEF_OBJECTDYING].m_sMaxFrame = 9;
	...
	//Assasain Officer
	m_stFrame[111][DEF_OBJECTSTOP].m_sFrameTime = 115;
	m_stFrame[111][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[111][DEF_OBJECTMOVE].m_sFrameTime = 100;//150;
	m_stFrame[111][DEF_OBJECTATTACK].m_sFrameTime = 150;
	m_stFrame[111][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[111][DEF_OBJECTDAMAGE].m_sFrameTime = 180;
	m_stFrame[111][DEF_OBJECTDAMAGE].m_sMaxFrame = 3;
	m_stFrame[111][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[111][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Houndeath
	m_stFrame[112][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[112][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[112][DEF_OBJECTMOVE].m_sFrameTime = 50;
	m_stFrame[112][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[112][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[112][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[112][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[112][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[112][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Helliche
	m_stFrame[113][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[113][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[113][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[113][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[113][DEF_OBJECTATTACK].m_sMaxFrame = 5;
	m_stFrame[113][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[113][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[113][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[113][DEF_OBJECTDYING].m_sMaxFrame = 9;

	// DeathWyvern
	m_stFrame[114][DEF_OBJECTSTOP].m_sFrameTime = 200;
	m_stFrame[114][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[114][DEF_OBJECTMOVE].m_sFrameTime = 90;
	m_stFrame[114][DEF_OBJECTATTACK].m_sFrameTime = 100;
	m_stFrame[114][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[114][DEF_OBJECTDAMAGE].m_sFrameTime = 100;
	m_stFrame[114][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	m_stFrame[114][DEF_OBJECTDYING].m_sFrameTime = 150;
	m_stFrame[114][DEF_OBJECTDYING].m_sMaxFrame = 7 + 3;

	// HellButcher
	m_stFrame[115][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[115][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[115][DEF_OBJECTMOVE].m_sFrameTime = 80;//150;
	m_stFrame[115][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[115][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[115][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[115][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[115][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[115][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// HellTroll
	m_stFrame[116][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[116][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[116][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[116][DEF_OBJECTATTACK].m_sFrameTime = 60;
	m_stFrame[116][DEF_OBJECTATTACK].m_sMaxFrame = 5;
	m_stFrame[116][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[116][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[116][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[116][DEF_OBJECTDYING].m_sMaxFrame = 9;

	// MountDeath
	m_stFrame[117][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[117][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[117][DEF_OBJECTMOVE].m_sFrameTime = 90;
	m_stFrame[117][DEF_OBJECTATTACK].m_sFrameTime = 100;
	m_stFrame[117][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[117][DEF_OBJECTDAMAGE].m_sFrameTime = 100;
	m_stFrame[117][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	m_stFrame[117][DEF_OBJECTDYING].m_sFrameTime = 150;
	m_stFrame[117][DEF_OBJECTDYING].m_sMaxFrame = 7 + 3;

	// Hellgoyle
	m_stFrame[118][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[118][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[118][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[118][DEF_OBJECTATTACK].m_sFrameTime = 70;
	m_stFrame[118][DEF_OBJECTATTACK].m_sMaxFrame = 9;
	m_stFrame[118][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[118][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	m_stFrame[118][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[118][DEF_OBJECTDYING].m_sMaxFrame = 11 + 3;

	// HellDemon
	m_stFrame[119][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[119][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[119][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[119][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[119][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[119][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[119][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[119][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[119][DEF_OBJECTDYING].m_sMaxFrame = 9;

	//HellAbaddon
	m_stFrame[120][DEF_OBJECTSTOP].m_sFrameTime = 200;//250
	m_stFrame[120][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[120][DEF_OBJECTMOVE].m_sFrameTime = 90;
	m_stFrame[120][DEF_OBJECTATTACK].m_sFrameTime = 100;
	m_stFrame[120][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[120][DEF_OBJECTDAMAGE].m_sFrameTime = 100;
	m_stFrame[120][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	m_stFrame[120][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[120][DEF_OBJECTDYING].m_sMaxFrame = 15 + 3;

	//GhostAba
	m_stFrame[121][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[121][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[121][DEF_OBJECTMOVE].m_sFrameTime = 100;
	m_stFrame[121][DEF_OBJECTATTACK].m_sFrameTime = 60;
	m_stFrame[121][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[121][DEF_OBJECTDAMAGE].m_sFrameTime = 120;
	m_stFrame[121][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 7;
	m_stFrame[121][DEF_OBJECTDYING].m_sFrameTime = 100;
	m_stFrame[121][DEF_OBJECTDYING].m_sMaxFrame = 9;

	//Goblin
	m_stFrame[122][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[122][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[122][DEF_OBJECTMOVE].m_sFrameTime = 80;//150;
	m_stFrame[122][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[122][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[122][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[122][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[122][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[122][DEF_OBJECTDYING].m_sMaxFrame = 7;

	//GmGoblin
	m_stFrame[123][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[123][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[123][DEF_OBJECTMOVE].m_sFrameTime = 80;//150;
	m_stFrame[123][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[123][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[123][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[123][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[123][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[123][DEF_OBJECTDYING].m_sMaxFrame = 7;

	//Danny
	m_stFrame[124][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[124][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[124][DEF_OBJECTMOVE].m_sFrameTime = 80;//150;
	m_stFrame[124][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[124][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[124][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[124][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[124][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[124][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Guard
	m_stFrame[125][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[125][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[125][DEF_OBJECTMOVE].m_sFrameTime = 90;//150;80
	m_stFrame[125][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[125][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[125][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[125][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[125][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[125][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Guard
	m_stFrame[126][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[126][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[126][DEF_OBJECTMOVE].m_sFrameTime = 90;//150;80
	m_stFrame[126][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[126][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[126][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[126][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[126][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[126][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// Guard
	m_stFrame[127][DEF_OBJECTSTOP].m_sFrameTime = 250;
	m_stFrame[127][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[127][DEF_OBJECTMOVE].m_sFrameTime = 90;//150;80
	m_stFrame[127][DEF_OBJECTATTACK].m_sFrameTime = 120;
	m_stFrame[127][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[127][DEF_OBJECTDAMAGE].m_sFrameTime = 150;
	m_stFrame[127][DEF_OBJECTDAMAGE].m_sMaxFrame = 3 + 4;
	m_stFrame[127][DEF_OBJECTDYING].m_sFrameTime = 180;
	m_stFrame[127][DEF_OBJECTDYING].m_sMaxFrame = 7;

	// BlackWyvern
	m_stFrame[128][DEF_OBJECTSTOP].m_sFrameTime = 150;
	m_stFrame[128][DEF_OBJECTSTOP].m_sMaxFrame = 7;
	m_stFrame[128][DEF_OBJECTMOVE].m_sFrameTime = 90;
	m_stFrame[128][DEF_OBJECTATTACK].m_sFrameTime = 100;
	m_stFrame[128][DEF_OBJECTATTACK].m_sMaxFrame = 7;
	m_stFrame[128][DEF_OBJECTDAMAGE].m_sFrameTime = 100;
	m_stFrame[128][DEF_OBJECTDAMAGE].m_sMaxFrame = 7;
	m_stFrame[128][DEF_OBJECTDYING].m_sFrameTime = 150;
	m_stFrame[128][DEF_OBJECTDYING].m_sMaxFrame = 7 + 3;

	// MarketMob
	m_stFrame[129][DEF_OBJECTSTOP].m_sFrameTime = 200;
	m_stFrame[129][DEF_OBJECTSTOP].m_sMaxFrame = 3;
	m_stFrame[129][DEF_OBJECTMOVE].m_sFrameTime = 90;
	m_stFrame[129][DEF_OBJECTMOVE].m_sMaxFrame = 3;
	m_stFrame[129][DEF_OBJECTATTACK].m_sFrameTime = 80;
	m_stFrame[129][DEF_OBJECTATTACK].m_sMaxFrame = 3;
	m_stFrame[129][DEF_OBJECTDAMAGE].m_sFrameTime = 60;
	m_stFrame[129][DEF_OBJECTDAMAGE].m_sMaxFrame = 3;
	m_stFrame[129][DEF_OBJECTDYING].m_sFrameTime = 65;
	m_stFrame[129][DEF_OBJECTDYING].m_sMaxFrame = 3 + 3;
...
m_pTmpData[ix][iy].Clear();* / //Original
...
void CMapData::ShiftMapData(char cDir)
{
	...
	else if (c_reso->IsResolution() == C1024x768)
	{
		...
		case 1:
			for (ix = 0; ix < 33; ix++)
				for (iy = 0; iy < 24; iy++)
					memcpy(&m_pTmpData[4 + 5 - 6 + ix][6 + 5 - 4 + iy], &m_pData[4 + 5 - 6 + ix][5 + 5 - 4 + iy], sizeof(class CTile));
			m_sPivotY--;
			break;
		case 2:
			for (ix = 0; ix < 32; ix++)
				for (iy = 0; iy < 24; iy++)
					memcpy(&m_pTmpData[4 + 5 - 6 + ix][6 + 5 - 4 + iy], &m_pData[5 + 5 - 6 + ix][5 + 5 - 4 + iy], sizeof(class CTile));
			m_sPivotX++;
			m_sPivotY--;
			break;
		case 3:
			for (ix = 0; ix < 32; ix++)
				for (iy = 0; iy < 25; iy++)
					memcpy(&m_pTmpData[4 + 5 - 6 + ix][5 + 5 - 4 + iy], &m_pData[5 + 5 - 6 + ix][5 + 5 - 4 + iy], sizeof(class CTile));
			m_sPivotX++;
			break;
		case 4:
			for (ix = 0; ix < 32; ix++)
				for (iy = 0; iy < 24; iy++)
					memcpy(&m_pTmpData[4 + 5 - 6 + ix][5 + 5 - 4 + iy], &m_pData[5 + 5 - 6 + ix][6 + 5 - 4 + iy], sizeof(class CTile));
			m_sPivotX++;
			m_sPivotY++;
			break;
		case 5:
			for (ix = 0; ix < 33; ix++)
				for (iy = 0; iy < 24; iy++)
					memcpy(&m_pTmpData[4 + 5 - 6 + ix][5 + 5 - 4 + iy], &m_pData[4 + 5 - 6 + ix][6 + 5 - 4 + iy], sizeof(class CTile));
			m_sPivotY++;
			break;
		case 6:
			for (ix = 0; ix < 32; ix++)
				for (iy = 0; iy < 24; iy++)
					memcpy(&m_pTmpData[5 + 5 - 6 + ix][5 + 5 - 4 + iy], &m_pData[4 + 5 - 6 + ix][6 + 5 - 4 + iy], sizeof(class CTile));
			m_sPivotX--;
			m_sPivotY++;
			break;
		case 7:
			for (ix = 0; ix < 32; ix++)
				for (iy = 0; iy < 25; iy++)
					memcpy(&m_pTmpData[5 + 5 - 6 + ix][5 + 5 - 4 + iy], &m_pData[4 + 5 - 6 + ix][5 + 5 - 4 + iy], sizeof(class CTile));
			m_sPivotX--;
			break;
		case 8:
			for (ix = 0; ix < 32; ix++)
				for (iy = 0; iy < 24; iy++)
					memcpy(&m_pTmpData[5 + 5 - 6 + ix][6 + 5 - 4 + iy], &m_pData[4 + 5 - 6 + ix][5 + 5 - 4 + iy], sizeof(class CTile));
			m_sPivotX--;
			m_sPivotY--;
			break;
		}
...
BOOL CMapData::bGetIsLocateable(short sX, short sY)
{
	...
	// Validar si las coordenadas (sX, sY) están dentro de los límites globales
...
BOOL CMapData::bGetIsLocateable(short sX, short sY)
{
	...
	if (m_pData[dX + 1][dY + 1].m_sOwnerType == 114) return FALSE;
	if (m_pData[dX + 1][dY].m_sOwnerType == 114) return FALSE;
	if (m_pData[dX + 1][dY - 1].m_sOwnerType == 114) return FALSE;
	if (m_pData[dX][dY + 1].m_sOwnerType == 114) return FALSE;
	if (m_pData[dX][dY].m_sOwnerType == 114) return FALSE;
	if (m_pData[dX][dY - 1].m_sOwnerType == 114) return FALSE;
	if (m_pData[dX - 1][dY + 1].m_sOwnerType == 114) return FALSE;
	if (m_pData[dX - 1][dY].m_sOwnerType == 114) return FALSE;
	if (m_pData[dX - 1][dY - 1].m_sOwnerType == 114) return FALSE;

	if (m_pData[dX + 1][dY + 1].m_sOwnerType == 120) return FALSE;
	if (m_pData[dX + 1][dY].m_sOwnerType == 120) return FALSE;
	if (m_pData[dX + 1][dY - 1].m_sOwnerType == 120) return FALSE;
	if (m_pData[dX][dY + 1].m_sOwnerType == 120) return FALSE;
	if (m_pData[dX][dY].m_sOwnerType == 120) return FALSE;
	if (m_pData[dX][dY - 1].m_sOwnerType == 120) return FALSE;
	if (m_pData[dX - 1][dY + 1].m_sOwnerType == 120) return FALSE;
	if (m_pData[dX - 1][dY].m_sOwnerType == 120) return FALSE;
	if (m_pData[dX - 1][dY - 1].m_sOwnerType == 120) return FALSE;
...
BOOL __fastcall CMapData::bSetOwner(WORD wObjectID, int sX, int sY, int sType, int cDir, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor, int iApprColor2, int iStatus, char * pName, short sAction, short sV1, short sV2, short sV3, int iPreLoc, int iFrame, char AdminLevel)
{
	...
	if ((wObjectID < 30000) && (sAction != DEF_OBJECTNULLACTION))
	{
		...
		if (m_iObjectIDcacheLocX[wObjectID] > 0)
		{
			...
			if (m_pData[iX][iY].m_wObjectID == wObjectID)
			{
				...
				m_pData[iX][iY].m_wObjectID = NULL;
				m_pData[iX][iY].m_iChatMsg = NULL;
				m_pData[iX][iY].m_sOwnerType = NULL;
				ZeroMemory(m_pData[iX][iY].m_cOwnerName, sizeof(m_pData[iX][iY].m_cOwnerName));
		...
		for (iX = sX - iAdd; iX <= sX + iAdd; iX++)
			for (iY = sY - iAdd; iY <= sY + iAdd; iY++)
			{
				...
				if (m_pData[iX - m_sPivotX][iY - m_sPivotY].m_wObjectID == wObjectID)
				{
					...
					m_pData[iX - m_sPivotX][iY - m_sPivotY].m_wObjectID = NULL;
				...
				if (m_pData[iX - m_sPivotX][iY - m_sPivotY].m_wDeadObjectID == wObjectID)
				{
					...
					iEffectFrame = m_pData[iX - m_sPivotX][iY - m_sPivotY].m_iEffectFrame;
					iEffectTotalFrame = m_pData[iX - m_sPivotX][iY - m_sPivotY].m_iEffectTotalFrame;
					m_pData[iX - m_sPivotX][iY - m_sPivotY].m_wDeadObjectID = NULL;
	...
	//	m_pGame->AddEventList("16");
		return FALSE;
	}

EXIT_SEARCH_LOOP:;

	/*	m_pGame->SoltaElMouseWachin();*/
	...
	if (m_pData[dX][dY].m_sOwnerType != NULL)
	{
		...
		{
			m_pGame->RequestFullObjectData(wObjectID);
		//	m_pGame->AddEventList("17");
			return FALSE;
		}
		else
		{

		//	m_pGame->AddEventList("18");
			return FALSE;
		}
	}
...
BOOL __fastcall CMapData::bGetOwner(short sX, short sY, short * pOwnerType, char * pDir, short * pAppr1, short * pAppr2, short * pAppr3, short * pAppr4, int * pApprColor, int * pApprColor2, int * pStatus, char * pName, char * pAction, char * pFrame, int * pChatIndex, short * pV1, short * pV2, char * AdminLevel)
{
	int dX, dY;
	...
	auto& data = m_pData[dX][dY];

	*pOwnerType = data.m_sOwnerType;
	*pAction = data.m_cOwnerAction;
	*pDir = data.m_cDir;
	*pFrame = data.m_cOwnerFrame;
	*pAppr1 = data.m_sAppr1;
	*pAppr2 = data.m_sAppr2;
	*pAppr3 = data.m_sAppr3;
	*pAppr4 = data.m_sAppr4;
	*pApprColor = data.m_iApprColor;
	*pApprColor2 = data.m_iApprColor2;
	*pStatus = data.m_iStatus;
	*pChatIndex = data.m_iChatMsg;
	*pV1 = data.m_sV1;
	*pV2 = data.m_sV2;

	strcpy(pName, data.m_cOwnerName);
...
BOOL __fastcall CMapData::bGetDeadOwner(short sX, short sY, short * pOwnerType, char * pDir, short * pAppr1, short * pAppr2, short * pAppr3, short * pAppr4, int * pApprColor, int * pApprColor2, char * pFrame, char * pName, short * pItemSprite, short * pItemSpriteFrame, int * pChatIndex)
{
	int dX, dY;
	...
	*pApprColor2 = m_pData[dX][dY].m_iDeadApprColor2; // v1.4
...
int CMapData::iObjectFrameCounter(char * cPlayerName, short sViewPointX, short sViewPointY)
{
	...
	//velocidad
	if ((dwTime - m_dwFrameTime) >= 1)//80 //aca esta en 1 esta bien bro xD
		m_dwFrameTime = dwTime;

	//added resolution ver aca
	sCenterX = m_pGame->m_sPlayerX - m_sPivotX;
	sCenterY = m_pGame->m_sPlayerY - m_sPivotY;
	...
	if ((dwTime - S_dwUpdateTime) > 40) bAutoUpdate = TRUE;//cambio actualizar
		...
		for (dY = 0; dY < MAPDATASIZEY; dY++)
		{
				...
				if ((m_pData[dX][dY].m_sDynamicObjectType != NULL))
				{
					...
					case DEF_DYNAMICOBJECT_FIRE3: // by Snoopy(FireBow)
						...
						if (m_pData[dX][dY].m_cDynamicObjectFrame == 1)
						{
							...
							{
								pan = 600;// asi lo tengo no se porq fui probando y quedo ja ja eexplicacion cientifica no hay JAJAJA
							...
							lPan = -(sCenterX - dX) * pan;
							m_pGame->PlaySound('E', 9, sDist);

							//m_pGame->PlaySound('E', 9, sDist); original
						}
						break;
					...
					case DEF_DYNAMICOBJECT_HEALSPOT:
						if (m_pData[dX][dY].m_cDynamicObjectFrame >= 8)
						{
							m_pData[dX][dY].m_sDynamicObjectType = DEF_DYNAMICOBJECT_HEALSPOT_LOOP;
							m_pData[dX][dY].m_cDynamicObjectFrame = rand() % 8;
						}
						break;

					case DEF_DYNAMICOBJECT_HEALSPOT_LOOP:
						if (m_pData[dX][dY].m_cDynamicObjectFrame >= 8)
						{
							m_pData[dX][dY].m_cDynamicObjectFrame = 0;
						}
			...
			if (m_pData[dX][dY].m_sDeadOwnerType != NULL) //00496F62  JE SHORT 00496FD8
				if ((m_pData[dX][dY].m_cDeadOwnerFrame >= 0) && ((dwTime - m_pData[dX][dY].m_dwDeadOwnerTime) > 150))
				{
					...
					{
						iRet = -1;
						S_dwUpdateTime = dwTime;//cambio actualizar
					}
			...
			if (m_pData[dX][dY].m_sOwnerType != NULL)
			{
				...
				case DEF_OBJECTMAGIC:
					if (m_pGame->m_cSkillMastery[4] == 100) iDelay = -17;//-13 Timer Magic
					else iDelay = 0;
					break;
				default:
					iDelay = 0;
				...
				///LA VERDADERA MAGIA para zero que lo mira por tv
				...
				m_pData[dX][dY].m_dwOwnerTime = dwTime; //dwFrameTime; //dwTime new w10*/
				...
				if ((dwTime - m_pData[dX][dY].m_dwOwnerTime) > dwFrameTime)
				{
					...
					{
						if (m_pData[dX][dY].m_bSpriteOmit)
							m_pData[dX][dY].m_cOwnerFrame++;
					}
					else {
						m_pData[dX][dY].m_cOwnerFrame++;
					...
					if (m_pData[dX][dY].m_cOwnerFrame > m_stFrame[m_pData[dX][dY].m_sOwnerType][m_pData[dX][dY].m_cOwnerAction].m_sMaxFrame)
					{
						...
						if ((m_sRectX <= dX) && ((m_sRectX + tmpx) >= dX)
							&& (m_sRectY <= dY) && ((m_sRectY + tmpy) >= dY))
							// (!) Ower -> DeadOwner 004971AB
						{
							if (m_pData[dX][dY].m_cOwnerAction == DEF_OBJECTDYING) //10
							{
								...
								m_pData[dX][dY].m_iDeadApprColor2 = m_pData[dX][dY].m_iApprColor2; // v1.4
								m_pData[dX][dY].m_iDeadStatus = m_pData[dX][dY].m_iStatus;
								m_pData[dX][dY].m_cDeadAdminLevel = m_pData[dX][dY].m_cAdminLevel;
					...
					if (m_pData[dX][dY].m_cOwnerAction == DEF_OBJECTSTOP) { // DEF_OBJECTSTOP = 1 // 00497334
						...
						case 6: // glowing armor/weapon
							...
							{
								int screenWidth = 800;  // Función para obtener el ancho de la pantalla
								int screenHeight = 600; // Función para obtener el alto de la pantalla

								int effectX = screenWidth - 50;
								int effectY = screenHeight - 50;

								if ((m_pData[dX][dY].m_iStatus & 0x10) == 0 && m_pGame->bPlayerShines) m_pGame->bAddNewEffect(54, (m_sPivotX + dX) * 32 + (rand() % 20 - 10), (m_sPivotY + dY) * 32 - (rand() % 50) - 5, NULL, NULL, -(rand() % 8), 0);
/*

								m_pGame->bAddNewEffect(54,
									effectX + (rand() % 20 - 10),
									effectY - (rand() % 50) - 5,
									NULL, NULL, -(rand() % 8), 0);*/
						...
						case 54: // Dark-Elf
							...
							if ((m_pData[dX][dY].m_cOwnerFrame == 1 && m_pData[dX][dY].m_bSpriteOmit) || (m_pData[dX][dY].m_cOwnerFrame == 5 && m_pData[dX][dY].m_bSpriteOmit)) {
								...
								{*/
									...
									if ((m_pData[dX][dY].m_iStatus & 0x10) == 0 && m_pGame->bPlayerShines) m_pGame->bAddNewEffect(54, (m_sPivotX + dX) * 32 + dx + (rand() % 20 - 10), (m_sPivotY + dY) * 32 + dy - (rand() % 50) - 5, NULL, NULL, -(rand() % 8), 0);
					...
					if (m_pData[dX][dY].m_cOwnerAction == DEF_OBJECTATTACKMOVE)  //8 //004980A5
					{
						...
						case 6:
							...
							else if (m_pData[dX][dY].m_cOwnerFrame == 5) // vu comme case 5
							{
								...
								else if ((sWeaponType >= 51) && (sWeaponType <= 70))
								{
									if (m_pData[dX][dY].m_bSpriteOmit) m_pGame->PlaySound('C', 18, sDist, lPan);
								}
							}
					...
					if ((m_pData[dX][dY].m_cOwnerAction == DEF_OBJECTATTACK)) { //3 00498685
						...
						case 6: // Humans
							if ((m_pData[dX][dY].m_sV3 >= 20) && (m_pData[dX][dY].m_cOwnerFrame == 2))
								//Reparando warning LaloRamos anulado v11 - Agregado (unsigned char)
							{
								//	if  ( m_pGame->bHasHeroSet(m_pData[dX][dY].m_sAppr3, m_pData[dX][dY].m_sAppr4, (unsigned char)m_pData[dX][dY].m_sOwnerType) == 1) // Warr hero set
								//{
								...
								//	if  ( m_pGame->bHasHeroSet(m_pData[dX][dY].m_sAppr3, m_pData[dX][dY].m_sAppr4, (unsigned char)m_pData[dX][dY].m_sOwnerType) == 3) // Warr hero set
								if (m_pGame->bHasHeroSet(m_pData[dX][dY].m_sAppr3, m_pData[dX][dY].m_sAppr4, m_pData[dX][dY].m_sOwnerType) == 3) // Warr hero set
								{
									m_pGame->bAddNewEffect(246, m_sPivotX + dX, m_sPivotY + dY
										, m_sPivotX + dX, m_sPivotY + dY, 0, 1);
								}
						...
						default:
							if ((m_pData[dX][dY].m_cOwnerFrame == 1) || (m_pData[dX][dY].m_cOwnerFrame == 3))
							{
								if (m_pData[dX][dY].m_bSpriteOmit) m_pGame->PlaySound('C', 8, sDist, lPan);
							}
							break;
						}
					}
					...
					if (m_pData[dX][dY].m_cOwnerAction == DEF_OBJECTDAMAGE)  // 6  00499159
					{
						...
						default:
							...
							switch (m_pData[dX][dY].m_sOwnerType) {
							case 88: // Snoopy: Barbarian
								if (m_pData[dX][dY].m_cOwnerFrame == 1) { if (m_pData[dX][dY].m_bSpriteOmit)  m_pGame->PlaySound('M', 144, sDist, lPan); }
								break;

							case 83: // Snoopy: ATK
								if (m_pData[dX][dY].m_cOwnerFrame == 1) { if (m_pData[dX][dY].m_bSpriteOmit)  m_pGame->PlaySound('M', 143, sDist, lPan); }
								break;
							...
							case 54: // DE
								if (m_pData[dX][dY].m_cOwnerFrame == 5) { if (m_pData[dX][dY].m_bSpriteOmit)  m_pGame->PlaySound('C', 13, sDist, lPan); }
								break;
							...
							case 62://DireBoar
								...
								break;
							case 63://Frost
								if ((m_pData[dX][dY].m_cOwnerFrame == 1)) { if (m_pData[dX][dY].m_bSpriteOmit) m_pGame->PlaySound('C', 13, sDist, lPan); }
								break;
					...
					if (m_pData[dX][dY].m_cOwnerAction == DEF_OBJECTDAMAGEMOVE) { // 7 004997BD
						...
						default:
							...
							case 84: // Snoopy: MasterElf
								if (m_pData[dX][dY].m_cOwnerFrame == 1)
								{
									if (m_pData[dX][dY].m_bSpriteOmit) m_pGame->PlaySound('C', 7, sDist, lPan);
								}
								break;
							case 88: // Snoopy: Barbarian
								if (m_pData[dX][dY].m_cOwnerFrame == 1)
					...
					if (m_pData[dX][dY].m_cOwnerAction == DEF_OBJECTMAGIC)  // 4 00499D51
					{
						...
						case 6:
							if (m_pData[dX][dY].m_cOwnerFrame == 1)
							{
								...
								//Reparando warning LaloRamos anulado v11 - Agregado (unsigned char)
								//	if  ( m_pGame->bHasHeroSet(m_pData[dX][dY].m_sAppr3, m_pData[dX][dY].m_sAppr4, (unsigned char)m_pData[dX][dY].m_sOwnerType) == 2) // Mage hero set
								...
								if (m_pGame->bHasHeroSet(m_pData[dX][dY].m_sAppr3, m_pData[dX][dY].m_sAppr4, m_pData[dX][dY].m_sOwnerType) == 4) // Mage hero set
									//	if (m_pGame->bHasHeroSet(m_pData[dX][dY].m_sAppr3, m_pData[dX][dY].m_sAppr4, (unsigned char)m_pData[dX][dY].m_sOwnerType) == 4) // Mage hero set
								{
									m_pGame->bAddNewEffect(245, m_sPivotX + dX, m_sPivotY + dY
										, m_sPivotX + dX, m_sPivotY + dY, 0, 1);
								}
	...
	//Hasta aca
	//MAGIA FUERTE.
	if (dynObjsNeedUpdate) m_dwDOframeTime = dwTime;
	return iRet;
}
...
BOOL CMapData::bSetItem(short sX, short sY, short sItemSpr, short sItemSprFrame, char cItemColor, BOOL bDropEffect)
{
	...
	{
		sAbsX = abs(((m_pGame->m_sViewPointX / 32) + 16) - sX);
		sAbsY = abs(((m_pGame->m_sViewPointY / 32) + 11) - sY);//11
	}
...
BOOL __fastcall CMapData::bSetDeadOwner(WORD wObjectID, short sX, short sY, short sType, char cDir, short sAppr1, short sAppr2, short sAppr3, short sAppr4, int iApprColor, int iApprColor2, int iStatus, char * pName, char AdminLevel)
{
	int  dX, dY;
	char pTmpName[12];
	...
	m_pData[dX][dY].m_iDeadApprColor2 = iApprColor2;
	m_pData[dX][dY].m_iDeadStatus = iStatus;
	m_pData[dX][dY].m_cDeadAdminLevel = AdminLevel;
	m_pData[dX][dY].m_cDeadOwnerFrame = -1;
...
BOOL CMapData::bSetDynamicObject(short sX, short sY, WORD wID, short sType, BOOL bIsEvent)
{
	...
	if ((sX < m_sPivotX) || (sX >= m_sPivotX + MAPDATASIZEX) || (sY < m_sPivotY) || (sY >= m_sPivotY + MAPDATASIZEY)) return FALSE;
...
void CMapData::GetOwnerStatusByObjectID(WORD wObjectID, char *pOwnerType, char *pDir, short *pAppr1, short *pAppr2, short *pAppr3, short *pAppr4, int * pStatus, int * pColor, int * pColor2, char * pName)
{
	int iX, iY;
	for (iX = 0; iX < MAPDATASIZEX; iX++)
		for (iY = 0; iY < MAPDATASIZEY; iY++)
